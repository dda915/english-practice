...
KO_STARTER_QUESTIONS = [
    # ── ステージ0a: 文字の練習（母音）。お手本を見て同じハングルを書く ──
    #   unit_number 0.1〜0.2（1未満）は「文字を書く練習」として採点側で特別扱い。
    (1, 0.1, "「ア」と よむよ。「아」を かいてね", "아"),
    (2, 0.1, "「イ」と よむよ。「이」を かいてね", "이"),
    (3, 0.1, "「ウ」と よむよ。「우」を かいてね", "우"),
    (4, 0.1, "「エ」と よむよ。「에」を かいてね", "에"),
    (5, 0.1, "「オ」と よむよ。「오」を かいてね", "오"),
    (6, 0.1, "「ヤ」と よむよ。「야」を かいてね", "야"),
    (7, 0.1, "「ユ」と よむよ。「유」を かいてね", "유"),
    (8, 0.1, "「ヨ」と よむよ。「요」を かいてね", "요"),
    # ── ステージ0b: 文字の練習（가나だ＝子音＋ア） ──
    (9, 0.2, "「カ」と よむよ。「가」を かいてね", "가"),
    (10, 0.2, "「ナ」と よむよ。「나」を かいてね", "나"),
    (11, 0.2, "「タ」と よむよ。「다」を かいてね", "다"),
    (12, 0.2, "「ラ」と よむよ。「라」を かいてね", "라"),
    (13, 0.2, "「マ」と よむよ。「마」を かいてね", "마"),
    (14, 0.2, "「パ」と よむよ。「바」を かいてね", "바"),
    (15, 0.2, "「サ」と よむよ。「사」を かいてね", "사"),
    (16, 0.2, "「チャ」と よむよ。「자」を かいてね", "자"),
    (17, 0.2, "「ハ」と よむよ。「하」を かいてね", "하"),
